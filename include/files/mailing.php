...
if (eregi("mailing.php", $_SERVER['PHP_SELF'])) {
	die ("You cannot open this page directly");
}

/*** verification securite ***/
if ($grade['a']!='a'&&$grade['b']!='b'&&$grade['l']!='l') {js_goto($PHP_SELF);} 
...
<?php
	...
	echo "<select name=list1 style=\"width:120\" MULTIPLE SIZE=10 onDblClick=\"moveSelectedOptions(this.form['list1'],this.form['list2'],true)\">";
	while ($joueur = $db->fetch($joueurs)) {
	...
	echo "<select name=list2 style=\"width:120\" MULTIPLE SIZE=10 onDblClick=\"moveSelectedOptions(this.form['list2'],this.form['list1'],true)\">";
	echo "</select>";
	echo "</td>";
	//echo "<td width=1>&nbsp;</td>";
	echo "</tr>";
