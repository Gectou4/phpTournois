...
echo '<table width=100% align=center valign=center><tr><td width=100%><br><i><div align="center">'.$strFLOG.'</div></i></td></tr>';

echo "<tr><td align=center><br><p class=title>.:: $strConnexion ::.</p>";
	...
	echo "<br><br><img src=\"images/back.gif\" border=0 align=align=absmiddle> <a href=javascript:back() class=action>$strRetour</a><br></td></tr></table>";
