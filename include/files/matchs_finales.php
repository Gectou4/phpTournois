...
/*
   ...
   +---------------------------------------------------------------------+
*/
if (eregi("matchs_finales.php", $_SERVER['PHP_SELF'])) {
...
//	echo " nb_finales_winner : $nb_finales_winner|";
	...
	if($op=='admin') {
		...
		if($modescore_tournois=='M4') {
			...
			echo "<td class=text align=right>$strCamps Terro :</td><td class=text><select name=m4camps><option value=0";if($m4campscfg==0) echo " SELECTED";echo ">$strAleatoire<option value=1";if($m4campscfg==1) echo " SELECTED";echo ">$strEquipe 1<option value=2";if($m4campscfg==2) echo " SELECTED";echo ">$strEquipe 2</select></td>";
			echo "<td class=text align=right>$strProlongation :</td><td class=text><input type=checkbox name=m4prolongation";if($m4prolongationcfg==1) echo " CHECKED";echo " style=\"border: 0px;background-color:transparent;\"></td>";
			echo "<td class=text align=right>$strAutoStart :</td><td class=text><input type=checkbox name=m4autostart";if($m4autostartcfg==1) echo " CHECKED";echo " style=\"border: 0px;background-color:transparent;\"></td>";
			echo "</tr>";
		}
		elseif($modescore_tournois=='AB') {
			...
			echo "<td class=text align=right>$strCamps Terro :</td><td class=text><select name=abcamps><option value=0";if($abcampscfg==0) echo " SELECTED";echo ">$strAleatoire<option value=1";if($abcampscfg==1) echo " SELECTED";echo ">$strEquipe 1<option value=2";if($abcampscfg==2) echo " SELECTED";echo ">$strEquipe 2</select></td>";
			...
			echo "<td class=text align=right>$strAutoStart :</td><td class=text><input type=checkbox name=abautostart";if($abautostartcfg==1) echo " CHECKED";echo " style=\"border: 0px;background-color:transparent;\"></td>";
			echo "</tr>";
		}
		else {
