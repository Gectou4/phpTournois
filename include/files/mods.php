...
if (preg_match("/mods.php/i", $_SERVER['PHP_SELF'])) {
 ...
 */
    ...
    echo "<input type=radio name=nom value=1 style=\"border: 0px;background-color:#66CC66;\"";
    if ($modsp->nom == "1") echo " CHECKED";
    echo "> $strOui ";
    echo "<input type=radio name=nom value=0 style=\"border: 0px;background-color:#FF6666;\"";
    if ($modsp->nom == "0") echo " CHECKED";
    echo "> $strNon";
    echo "</td></tr>";
    ...
    echo "<td class=textfichemods>";
    echo "<input type=radio name=prenom value=1 style=\"border: 0px;background-color:#66CC66;\"";
    if ($modsp->prenom == "1") echo " CHECKED";
    echo "> $strOui ";
    echo "<input type=radio name=prenom value=0 style=\"border: 0px;background-color:#FF6666;\"";
    if ($modsp->prenom == "0") echo " CHECKED";
    echo "> $strNon";
    echo "</td></tr>";
    ...
    echo "<td class=textfichemods>";
    echo "<input type=radio name=age value=1 style=\"border: 0px;background-color:#66CC66;\"";
    if ($modsp->age == "1") echo " CHECKED";
    echo "> $strOui ";
    echo "<input type=radio name=age value=0 style=\"border: 0px;background-color:#FF6666;\"";
    if ($modsp->age == "0") echo " CHECKED";
    echo "> $strNon";
    echo "</td></tr>";
    ...
    echo "<td class=textfichemods>";
    echo "<input type=radio name=ville value=1 style=\"border: 0px;background-color:#66CC66;\"";
    if ($modsp->ville == "1") echo " CHECKED";
    echo "> $strOui ";
    echo "<input type=radio name=ville value=0 style=\"border: 0px;background-color:#FF6666;\"";
    if ($modsp->ville == "0") echo " CHECKED";
    echo "> $strNon";
    echo "</td></tr>";
    ...
    echo "<td class=textfichemods>";
    echo "<input type=radio name=forcing value=1 style=\"border: 0px;background-color:#66CC66;\"";
    if ($modsp->forcing == "1") echo " CHECKED";
    echo "> $strOui ";
    echo "<input type=radio name=forcing value=0 style=\"border: 0px;background-color:#FF6666;\"";
    if ($modsp->forcing == "0") echo " CHECKED";
    echo "> $strNon";
    echo "</td></tr>";
    ...
    echo "<td class=textfichemods>";
    echo "<input type=radio name=topdl value=1 style=\"border: 0px;background-color:#66CC66;\"";
    if ($modsp->topdl == "1") echo " CHECKED";
    echo "> $strOui ";
    echo "<input type=radio name=topdl value=0 style=\"border: 0px;background-color:#FF6666;\"";
    if ($modsp->topdl == "0") echo " CHECKED";
    echo "> $strNon";
    echo "</td></tr>";
    ...
    echo "<td class=textfichemods>";
    echo "<input type=radio name=topplayer value=1 style=\"border: 0px;background-color:#66CC66;\"";
    if ($modsp->topplayer == "1") echo " CHECKED";
    echo "> $strOui ";
    echo "<input type=radio name=topplayer value=0 style=\"border: 0px;background-color:#FF6666;\"";
    if ($modsp->topplayer == "0") echo " CHECKED";
    echo "> $strNon";
    echo "</td></tr>";
    ...
    echo "<td class=textfichemods>";
    echo "<input type=radio name=lastresult value=1 style=\"border: 0px;background-color:#66CC66;\"";
    if ($modsp->lastresult == "1") echo " CHECKED";
    echo "> $strOui ";
    echo "<input type=radio name=lastresult value=0 style=\"border: 0px;background-color:#FF6666;\"";
    if ($modsp->lastresult == "0") echo " CHECKED";
    echo "> $strNon";
    echo "</td></tr>";
    ...
    echo "<td class=textfichemods>";
    echo "<input type=radio name=lastnews value=1 style=\"border: 0px;background-color:#66CC66;\"";
    if ($modsp->lastnews == "1") echo " CHECKED";
    echo "> $strOui ";
    echo "<input type=radio name=lastnews value=0 style=\"border: 0px;background-color:#FF6666;\"";
    if ($modsp->lastnews == "0") echo " CHECKED";
    echo "> $strNon";
    echo "</td></tr>";
    ...
    echo "<td class=textfichemods>";
    echo "<input type=radio name=lastnews_header value=1 style=\"border: 0px;background-color:#66CC66;\"";
    if ($modsp->lastnews_header == "1") echo " CHECKED";
    echo "> $strOui ";
    echo "<input type=radio name=lastnews_header value=0 style=\"border: 0px;background-color:#FF6666;\"";
    if ($modsp->lastnews_header == "0") echo " CHECKED";
    echo "> $strNon";
    echo "</td></tr>";
    ...
    echo "<td class=textfichemods>";
    echo "<input type=radio name=customtheme value=1 style=\"border: 0px;background-color:#66CC66;\"";
    if ($modsp->customtheme == "1") echo " CHECKED";
    echo "> $strOui ";
    echo "<input type=radio name=customtheme value=0 style=\"border: 0px;background-color:#FF6666;\"";
    if ($modsp->customtheme == "0") echo " CHECKED";
    echo "> $strNon";
    echo "</td></tr>";
    ...
    echo "<td class=textfichemods>";
    echo "<input type=radio name=pagescript value=1 style=\"border: 0px;background-color:#66CC66;\"";
    if ($modsp->pagescript == "1") echo " CHECKED";
    echo "> $strOui ";
    echo "<input type=radio name=pagescript value=0 style=\"border: 0px;background-color:#FF6666;\"";
    if ($modsp->pagescript == "0") echo " CHECKED";
    echo "> $strNon";
    echo "</td></tr>";
    ...
    echo "<td class=textfichemods>";
    echo "<input type=radio name=Osteamid value=1 style=\"border: 0px;background-color:#66CC66;\"";
    if ($modsp->Osteamid == "1") echo " CHECKED";
    echo "> $strOui ";
    echo "<input type=radio name=Osteamid value=0 style=\"border: 0px;background-color:#FF6666;\"";
    if ($modsp->Osteamid == "0") echo " CHECKED";
    echo "> $strNon";
    echo "</td></tr>";
    ...
    echo "<td class=textfichemods>";
    echo "<input type=radio name=plan value=1 style=\"border: 0px;background-color:#66CC66;\"";
    if ($modsp->plan == "1") echo " CHECKED";
    echo "> $strOui ";
    echo "<input type=radio name=plan value=0 style=\"border: 0px;background-color:#FF6666;\"";
    if ($modsp->plan == "0") echo " CHECKED";
    echo "> $strNon";
    echo "</td></tr>";
    ...
    if ($config['default_lang'] == "english") {
        ...
        echo "<td class=textfichemods>";
        echo "<input type=radio name=news2 value=1 style=\"border: 0px;background-color:#66CC66;\"";
        if ($modsp->news2 == "1") echo " CHECKED";
        echo "> $strOui ";
        echo "<input type=radio name=news2 value=0 style=\"border: 0px;background-color:#FF6666;\"";
        if ($modsp->news2 == "0") echo " CHECKED";
        echo "> $strNon";
        echo "</td></tr>";
    }
    ...
    echo "<td class=textfichemods>";
    echo "<input type=radio name=rangforum value=1 style=\"border: 0px;background-color:#66CC66;\"";
    if ($modsp->rangforum == "1") echo " CHECKED";
    echo "> $strOui ";
    echo "<input type=radio name=rangforum value=0 style=\"border: 0px;background-color:#FF6666;\"";
    if ($modsp->rangforum == "0") echo " CHECKED";
    echo "> $strNon";
    echo "</td></tr>";
    ...
    echo "<td class=textfichemods>";
    echo "<input type=radio name=serverteam value=1 style=\"border: 0px;background-color:#66CC66;\"";
    if ($modsp->serverteam == "1") echo " CHECKED";
    echo "> $strOui ";
    echo "<input type=radio name=serverteam value=0 style=\"border: 0px;background-color:#FF6666;\"";
    if ($modsp->serverteam == "0") echo " CHECKED";
    echo "> $strNon";
    echo "</td></tr>";
    ...
    echo "<td class=textfichemods>";
    echo "<input type=radio name=auto_valid_team value=1 style=\"border: 0px;background-color:#66CC66;\"";
    if ($modsp->auto_valid_team == "1") echo " CHECKED";
    echo "> $strOui ";
    echo "<input type=radio name=auto_valid_team value=0 style=\"border: 0px;background-color:#FF6666;\"";
    if ($modsp->auto_valid_team == "0") echo " CHECKED";
    echo "> $strNon";
    echo "</td></tr>";
    ...
    echo "<td class=textfichemods>";
    echo "<input type=radio name=m_team_valid value=1 style=\"border: 0px;background-color:#66CC66;\"";
    if ($modsp->m_team_valid == "1") echo " CHECKED";
    echo "> $strOui ";
    echo "<input type=radio name=m_team_valid value=0 style=\"border: 0px;background-color:#FF6666;\"";
    if ($modsp->m_team_valid == "0") echo " CHECKED";
    echo "> $strNon";
    echo "</td></tr>";
    ...
    echo "<td class=textfichemods>";
    echo "<input type=radio name=bbcode value=1 style=\"border: 0px;background-color:#000044;\"";
    if ($modsp->bbcode == "1") echo " CHECKED";
    echo "> $strphpBB ";
    echo "<input type=radio name=bbcode value=0 style=\"border: 0px;background-color:#0000AA;\"";
    if ($modsp->bbcode == "0") echo " CHECKED";
    echo "> $streditor";
    echo "</td></tr>";
