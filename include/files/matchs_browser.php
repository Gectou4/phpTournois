...
if (preg_match("/matchs_browser.php/i", $_SERVER['PHP_SELF'])) {
...
function get_type($file)
{
    ...
    if ($pt != FALSE) {
        ...
        switch ($file_ext) {
            case "gif":
                $image = "images/browser/i_gif.gif";
                break;
            case "htm":
                $image = "images/browser/i_htm.gif";
                break;
            case "html":
                $image = "images/browser/i_htm.gif";
                break;
            case "bmp":
                $image = "images/browser/i_img.gif";
                break;
            case "jpg":
                $image = "images/browser/i_jpg.gif";
                break;
            case "mp3":
                $image = "images/browser/i_mp3.gif";
                break;
            case "exe":
                $image = "images/browser/i_pgm.gif";
                break;
            case "txt":
                $image = "images/browser/i_txt.gif";
                break;
            case "wav":
                $image = "images/browser/i_wav.gif";
                break;
            case "zip":
                $image = "images/browser/i_zip.gif";
                break;
            case "dem":
                $image = "images/browser/i_demo.gif";
                break;
            default:
                $image = "images/browser/i_other.gif";
                break;
        }
...
function p_get_file($match, $directory, $level)
{
    ...
    global $config, $strS, $strConfirmEffacerFile, $s_joueur, $grade;
