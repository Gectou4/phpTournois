...
global $db,$dbprefix;
		...
		$req = $db->query($sql) or die('<font color="red"><b>ERREUR : rangforum n\'a pus être ajouté à la table config </b></font><br>');
		...
		$req2 = $db->query($sql2) or die('<font color="red"><b>ERREUR : last_forum_join n\'a pus être ajouté à la table joueurs </b></font><br>');
		...
		$req3 = $db->query($sql3) or die('<font color="red"><b>ERREUR : forum_post n\'a pus être ajouté à la table joueurs </b></font><br>');
		...
		$req4 = $db->query($sql4) or die('<font color="red"><b>ERREUR : forum_userrank n\'a pus être ajouté à la table  joueur</b></font><br>');
		...
		$req5 = $db->query($sql5) or die('<font color="red"><b>ERREUR : cattopic n\'a pus être ajouté à la table forum_message </b></font><br>');
		...
		$req6 = $db->query($sql6) or die('<font color="red"><b>ERREUR : reserved n\'a pus être ajouté à la table forum </b></font><br>');
		...
		$db->exec();
		echo '<font color="green"><b> UPDATE de cattopic '.$ud->cattopic.' du topid : '.$ud->cattopic.' Effectué avec succès !</b></font><br>';
		
		
		}
		
		echo 'La mise à jour à été effectuée, vérifier quand même que tous c\'est bien passé.<br>
		pensez à supprimer ce fichier de votre ftp.';
	}	


echo '<br><br><a href="?page=mod_install&op=update"><b>cliquer ici pour lancer la MAJ</b></a><br>Elle sera achevée une fois la page suivante avec le texte de succés affiché.';
