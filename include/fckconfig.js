...
FCKConfig.ToolbarSets["phpT"] = [
	['Save','NewPage','Preview','-','Cut','Copy','Paste','PasteText','PasteWord','-','Print','SpellCheck'],
	['Find','Replace','-','SelectAll','RemoveFormat'],
	['Bold','Italic','Underline','StrikeThrough','-','Subscript','Superscript'],
	['OrderedList','UnorderedList','-','Outdent','Indent'],
	['JustifyLeft','JustifyCenter','JustifyRight','JustifyFull'],
	['Image','Table','Rule','SpecialChar','UniversalKey','Smiley','TextColor','BGColor','Style','Link','Unlink','Anchor'],
