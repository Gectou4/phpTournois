...
StrikeThrough		: "Přeškrtnut&eacute;",
...
HiddenFieldProp		: "Vlastnosti skryt&eacute;ho pole",
RadioButtonProp		: "Vlastnosti přepínače",
ImageButtonProp		: "Vlastností obrázkov&eacute;ho tlačítka",
TextFieldProp		: "Vlastnosti textov&eacute;ho pole",
...
DlgAdvancedTag		: "Rozšířen&eacute;",
DlgOpOther			: "&lt;Ostatní&gt;",
...
DlgLnkTypeURL		: "URL",
DlgLnkTypeAnchor	: "Kotva v t&eacute;to stránce",
DlgLnkTypeEMail		: "E-Mail",
DlgLnkProto			: "Protokol",
DlgLnkProtoOther	: "&lt;jiný&gt;",
DlgLnkURL			: "URL",
DlgLnkAnchorSel		: "Vybrat kotvu",
DlgLnkAnchorByName	: "Podle jm&eacute;na kotvy",
...
DlgLnkTargetSelf	: "Stejn&eacute; okno (_self)",
DlgLnkTargetTop		: "Hlavní okno (_top)",
DlgLnkTargetFrameName	: "Název cílov&eacute;ho rámu",
...
DlgCellRowSpan		: "Sloučen&eacute; řádky",
DlgCellCollSpan		: "Sloučen&eacute; sloupce",
...
PasteErrorCut	: "Bezpečnostní nastavení Vašeho prohlížeče nedovolují editoru spustit funkci pro vyjmutí zvolen&eacute;ho textu do schránky. Prosím vyjměte zvolený text do schránky pomocí klávesnice (Ctrl+X).",
PasteErrorCopy	: "Bezpečnostní nastavení Vašeho prohlížeče nedovolují editoru spustit funkci pro kopírování zvolen&eacute;ho textu do schránky. Prosím zkopírujte zvolený text do schránky pomocí klávesnice (Ctrl+C).",
...
DlgSpellNoSuggestions	: "- žádn&eacute; návrhy -",
DlgSpellProgress		: "Probíhá kontrola pravopisu...",
DlgSpellNoMispell		: "Kontrola pravopisu dokončena: Žádn&eacute; pravopisn&eacute; chyby nenalezeny",
...
DlgSelectChkMulti	: "Povolit mnohonásobn&eacute; výběry",
...
NumberedListProp	: "Vlastnosti číslovan&eacute;ho seznamu",
DlgLstType			: "Typ",
...
DlgLstTypeSRoman	: "Mal&eacute; římská číslice (i, ii, iii)",
DlgLstTypeLRoman	: "Velk&eacute; římsk&eacute; číslice (I, II, III)",

// Document Properties Dialog
DlgDocGeneralTab	: "Obecn&eacute;",
...
DlgDocBgNoScroll	: "Nerolovateln&eacute; pozadí",
DlgDocCText			: "Text",
DlgDocCLink			: "Odkaz",
