...
/************************************************/
/*** Flood variable ***/
\$config['flood_time']=$flood_time; // must be in minutes !!! Doit �tre en minutes !!! 
...
elseif($stage==3) {
	...
	if(!$adminemail || !eregi("^[a-z0-9\._-]+@+[a-z0-9\._-]+\.+[a-z]{2,3}$", $adminemail)) {
 		$erreur=1;
	...
	*/
	...
	echo "N'oubliez pas d'aller sur votre page configuration pour d�finir les nouvelles options de configurations !<br>";
