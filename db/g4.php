...
$req = "
		  ...
		  PRIMARY KEY  (`id`)
			...
			'phpTournois modded  !!', 
			'phpTournois modded  !!', 
			'Bienvenue sur cette version moddée de phpTournois. Attention cette version est compatible PHP 7 mais est à utiliser le plus possible en LAN. Le code date et malgrés notre attention à l\'époque, des bug/soucis de sécurité pourraient être présents. Il faudrait du temps pour reaire tout ça au propre.', 
			'Bienvenue sur cette version moddée de phpTournois. Attention cette version est compatible PHP 7 mais est à utiliser le plus possible en LAN. Le code date et malgrés notre attention à l\'époque, des bug/soucis de sécurité pourraient être présents. Il faudrait du temps pour reaire tout ça au propre.', 
			" . time() . ",
			'dr_cube_manga8.gif');
