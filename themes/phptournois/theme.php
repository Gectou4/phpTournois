	...
	<td>
		<table width="100%" height="12" border="0" cellpadding="0" cellspacing="0">
			<tr>
				...
				<td background="themes/phptournois/images/story-T.gif"><img src="themes/phptournois/images/story-7px.gif" width="7" height="7" alt=""></td>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="2">
						...
						<tr>
							...
							<td align="right" width="10%">								
								<?php
								if($config['horloge'] == 1) {								
									echo '<table cellspacing="0" cellpadding="0" border="0" bgcolor="#000000" style="margin-right:5px;"><tr><td>';
									...
									echo '</td></tr></table>';	
									echo '<script>show(\''.date('M, d Y H:i:s').'\');</script>';									
								}
								?>
							</td>
						</tr>
