...
function theme_header()
{
    ...
    global $strTournois, $strForum, $strInscriptions, $strAccueil, $strContact, $strSInscrire;
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="2">
                            ...
                            <table cellspacing="0" cellpadding="0" width="100%" height="40" border="0">
                                <tr>
                                    ...
                                    <td align="center" valign="top" width="20%">
                                        <a href="http://www.phptournois.net" target="_blank"><img
                                                    src="images/phptournois.gif" height="40" border="0"
                                                    align="absmiddle" alt="phptournois"></a>
                                    </td>
                                    <td align="center" valign="middle">
                                        <table cellspacing="2" cellpadding="2" border="0">
                                            <tr>
                                                <td>
                                                    <a href="?<?php echo $_SERVER['QUERY_STRING']; ?>&lang=francais"><img
                                                                src="images/flags/FR.gif" border="0" align="absmiddle"></a><a
                                                            href="?<?php echo $_SERVER['QUERY_STRING']; ?>&lang=english"><img
                                                                src="images/flags/UK.gif" border="0" align="absmiddle"></a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>&nbsp;</td>
                    ...
                    <tr>
                        ...
                        <td align="center" class="title" width="80%">
                            ...
                            <?php if ($config['forum']) {
                                echo "<a href=\"?page=forum\">$strForum</a>&nbsp;&nbsp;";
                            }
                    ...
                    <tr>
                        <td width="100%">
                            <div class="poweredby" align="center">
                                ...
                                Powered by&nbsp;<a class="poweredby" href="http://www.phptournois.net"
                                                   target="_blank"><b><font color="blue">phpTournois</font></b></a>&copy;&nbsp;<?php echo $config['version']; ?>
                            </div>
                        </td>
                        <td>
...
function theme_header_win()
{
    ...
    <table width="100%" height="12" border="0" cellpadding="0" cellspacing="0">
        <tr>
            <td width="7"><img src="themes/phptournois/images/story-TL.gif" width="7" height="12" align="middle" alt="">
            </td>
            <td background="themes/phptournois/images/story-T.gif"><img src="images/story-7px.gif" width="7" height="7"
                                                                        alt=""></td>
            <td width="7"><img src="themes/phptournois/images/story-TR.gif" width="7" height="12" align="middle" alt="">
            </td>
        </tr>
    </table>
...
function theme_footer_win()
{
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="7"><img src="themes/phptournois/images/story-BL.gif" width="7" height="12" align="middle" alt="">
            </td>
            <td background="themes/phptournois/images/story-B.gif"><img src="images/story-7px.gif" width="7" height="7"
                                                                        alt=""></td>
            <td width="7"><img src="themes/phptournois/images/story-BR.gif" width="7" height="12" align="middle" alt="">
            </td>
        </tr>
    </table>
    </td>
...
function theme_menu_left()
{
    ...
    $show_tournois_status = 'E';
    include("include/blocks/block_tournois.php");
    $show_tournois_status = 'T';
    include("include/blocks/block_tournois.php");
    ...
    if ($mods['topplayer']) {
        include("include/blocks/block_10player.php");
    }
...
function theme_openblock($titre)
{
    ...
    <tr>
        <td>
            <table background="themes/phptournois/images/menucenterback.gif" height="1" width="100%" cellspacing="0"
                   cellpadding="0" border="0">
                <tr>
                    <td height="1" width="11" valign="top"><img src="themes/phptournois/images/menucornergauche.gif"
                                                                border="0" alt=""></td>
                    <td height="1" class="headermenu"
                        background="themes/phptournois/images/menucenter.gif"><?php echo $titre; ?></td>
                    <td height="1" width="11" valign="top"><p align="right"><img
                                    src="themes/phptournois/images/menucornerdroit.gif" border="0" alt=""></p></td>
                </tr>
            </table>
        </td>
    </tr>
        ...
        <td>
            <table cellspacing="0" cellpadding="0" width="100%" border="0">
                <tr>
                    ...
                    <td width="100%" background="themes/phptournois/images/menubas.gif"><img height="1" alt=""
                                                                                             src="images/spacer.gif"
                                                                                             width="1" border="0"></td>
                    <td align="right"><img alt="" src="themes/phptournois/images/menubascornerdroit.gif" border="0">
                    </td>
                </tr>
            </table>
        </td>
...
function theme_closeblock_enligne($titre)
{
    ...
    <tr>
    <td>
    <table background="themes/phptournois/images/menucenterback.gif" align="center" height="1" width="100%"
           cellspacing="0" cellpadding="0" border="0">
        <tr>
            <td height="1" width="" valign="top"><img src="themes/phptournois/images/menucornerdroit2.gif" border="0"
                                                      alt="" bgcolor=navy></td>
            <td height="1" width="100%" class="headermenu" background="themes/phptournois/images/menucenter2.gif"
                align="center"><?php echo $titre; ?></td>
            <td height="1" width="11" valign="top"><p align="right"><img
                            src="themes/phptournois/images/menucornergauche2.gif" border="0" alt=""></p></td>
        </tr>
        </td>
        </tr>
    </table>
...
function theme_openblock_lastresult($titre)
{
    ...
    <table background="themes/phptournois/images/menucenterback.gif" align="center" height="1" width="100%"
           cellspacing="0" cellpadding="0" border="0">
        <tr>
            <td height="1" width="11" valign="top"><img src="themes/phptournois/images/menucornergauche.gif" border="0"
                                                        alt="" bgcolor=navy></td>
            <td height="1" class="headermenu" background="themes/phptournois/images/menucenter.gif"
                align="center"><?php echo $titre; ?></td>
            <td height="1" width="11" valign="top"><p align="right"><img
                            src="themes/phptournois/images/menucornerdroit.gif" border="0" alt=""></p></td>
        </tr>
